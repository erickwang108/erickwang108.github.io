                ...
                <div className="lg:order-first lg:row-span-2">
                  ...
                  <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                    <p>
                      ...
                      从最初使用windows系列，到近多年开始使用MacBook，计算机为我的工作带来丰富多彩的生活和工作。
                    </p>
                    <p>
                      我喜欢读书，从工作后慢慢的找到了适合我自己的学习方式：自学，随着计算机技术的不断更新，我们需要
                      不断更新自己的知识。从最初的web 1.0 &gt; web
                      2.0，我阅读了大量的计算机书籍，记忆最深的是: C++ Primer /
                      Servlet In Action / Sping in Action / JavaScript
                      Programmer’s Reference等。
                    </p>
                    <p>
